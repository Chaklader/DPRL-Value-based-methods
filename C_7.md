...
$$
\begin{align} z'*{1,1} &= (0.5 \times 5) + (-0.3 \times 3) + (0.1 \times 30) + (0.8 \times 1) - 1.0 = 4.4 \ z'*{1,2} &= (-0.2 \times 5) + (0.6 \times 3) + (-0.4 \times 30) + (0.3 \times 1) + 0.5 = -10.4 \ z'_{1,3} &= (0.4 \times 5) + (0.2 \times 3) + (0.7 \times 30) + (-0.5 \times 1) - 0.8 = 22.3 \end{align}
$$
...
$$
\begin{align} z'*{2,1} &= (0.6 \times 4.4) + (0.3 \times 22.3) + 0.2 = 9.53 \\ z'*{2,2} &= (-0.3 \times 4.4) + (0.7 \times 22.3) - 0.1 = 14.29 \end{align}
$$
...
```mermaid
flowchart TD
    A["NS queue = 8"] --> B1["h₁₁ = 5.9<br>Weight: 0.5<br>Contribution: 4.0"]
    A --> B2["h₁₂ = 0.0<br>Weight: -0.2<br>Contribution: -1.6<br>(killed by ReLU)"]
    A --> B3["h₁₃ = 23.5<br>Weight: 0.4<br>Contribution: 3.2"]
    ...
    B1 --> F1["h₂₁ = 10.79<br>Mixed from h₁₁ & h₁₃"]
    B3 --> F1

    B1 --> F2["h₂₂ = 14.58<br>Mixed from h₁₁ & h₁₃"]
    B3 --> F2

    F1 --> G["Q(s,a₁) = 8.606<br>Mixed from h₂₁ & h₂₂"]
    F2 --> G
